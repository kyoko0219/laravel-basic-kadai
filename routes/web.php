...
Route::get('/posts/create', [VendorController::class, 'create'])->middleware('auth');

Route::post('/posts/store', [VendorController::class, 'store'])->name('vendors.store')->middleware('auth');
